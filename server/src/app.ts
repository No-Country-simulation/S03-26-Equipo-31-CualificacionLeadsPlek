 ...
 *
 * @see       https://github.com/No-Country-simulation/S03-26-Equipo-31-CualificacionLeadsPlek/blob/develop-backend/server/README.md
 */
...
import mailerLiteRouter   from "./modules/mailerlite/mailerlite.routes";
...
app.use("/api/mailer-provider",  mailerLiteRouter);
